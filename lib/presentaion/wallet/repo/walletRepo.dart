...
class WalletRepo {
  ...
  Future<WalletTransactionModel> getWalletTransactionApi({required BuildContext context}) async {
    try {
      final response = await _api.get(ApiConstants.wallet, requiresAuth: true);
      ...
      if (e.error is NoInternetException) {
        showNoInternetScreen(
          context,
          onRetry: () => getWalletTransactionApi(context: context),
        );
