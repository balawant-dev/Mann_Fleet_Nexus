...
class _CustomDrawerState extends State<CustomDrawer> {
  ...
  Widget build(BuildContext context) {
    return Consumer<ProfileDetailViewModel>(builder: (context, profilePro, child) {
         ...
         navPush(context: context, action: EditProfile());
                ...
                child: Column(
                  children:  [
                        ...
                        Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: CustomImageView(
                              width: 80,
                              height: 80,
                              imagePath: profilePro.getProfileModel?.data?.user?.profilePic??"assets/images/person.png",
                              fit: BoxFit.contain,
                              imageType:profilePro.getProfileModel?.data?.user?.profilePic==null?ImageType.asset:ImageType.network,
                            ),
                            // child: CustomImageView(
                    ...
                    SizedBox(height: 12),
                    Text(
                      profilePro.getProfileModel?.data?.user?.name??"Guest User",
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 18,
                    ...
                    profilePro.getProfileModel?.data?.user?.email==null?SizedBox():     SizedBox(height: 6),
                    profilePro.getProfileModel?.data?.user?.email==null?SizedBox():   Text(
