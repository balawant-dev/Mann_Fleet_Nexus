...
import '../../../presentaion/profile/viewModel/profileViewModel.dart';
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<ShuttleProvider>(
        ...
        returnShiftId: widget.returnShiftId,
      );
    });
                    ...
                    : CustomButton(
                      ...
                      onTap: () async {
                        ...
                        if (data?.razorpay == null) {
                          ToastHelper.show(
                            context,
                            message:pro.errorMessage?? "Payment data not founddddd",
