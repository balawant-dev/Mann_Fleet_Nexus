...
class ShuttleRepo {
  ...
  Future<GetShuttlePassesModel> getShuttlePassesApi({
    ...
    try {
      final response = await _api.get(
        ApiConstants.shuttlePassDestinationPricing,
  ...
  Future<PurchaseShuttlePassModel> purchaseShuttlePassApi({
    required BuildContext context,
    required String source,
    required String destination,
    ...
    try {
      ...
      if (e.response != null) {
        final model = PurchaseShuttlePassModel.fromJson(e.response!.data);
        print(">>>>>>>>>>>>>>>>>>>>>>>>okkk");
  ...
  Future<GenerateQrModel> generateQrApi({
    required BuildContext context,
