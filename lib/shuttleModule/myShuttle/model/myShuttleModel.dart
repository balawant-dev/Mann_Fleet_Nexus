...
class MyShuttleData {
  ...
  // Return fields (for travelType: both)
  var returnSource;
  var returnDestination;
  ShuttleRoute? returnShuttleRoute;
  ShuttleShift? returnShuttleShift;

  var travelType;           // "single" or "both"
  var bookingDate;
  var pricePerRide;
  var totalRides;
  var remainingRides;
  ...
  MyShuttleData({
    ...
    this.returnShuttleRoute,
    this.returnShuttleShift,
    this.travelType,
    this.bookingDate,
    this.pricePerRide,
    this.totalRides,
  ...
  MyShuttleData.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
    shuttlePass = json['shuttlePass'] != null
        ? ShuttlePass.fromJson(json['shuttlePass'])
        : null;
    user = json['user'];
    source = json['source'];
    destination = json['destination'];
    shuttleRoute = json['shuttleRoute'] != null
        ? ShuttleRoute.fromJson(json['shuttleRoute'])
        : null;
    shuttleShift = json['shuttleShift'] != null
        ? ShuttleShift.fromJson(json['shuttleShift'])
        : null;

    // Return fields
    returnSource = json['returnSource'];
    returnDestination = json['returnDestination'];
    returnShuttleRoute = json['returnShuttleRoute'] != null
        ? ShuttleRoute.fromJson(json['returnShuttleRoute'])
        : null;
    returnShuttleShift = json['returnShuttleShift'] != null
        ? ShuttleShift.fromJson(json['returnShuttleShift'])
        : null;

    travelType = json['travelType'] ?? 'single';
    bookingDate = json['bookingDate'];
    pricePerRide = json['pricePerRide'];
    totalRides = json['totalRides'];
    remainingRides = json['remainingRides'];
  ...
  // toJson() similarly updated...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = {};
    data['_id'] = sId;
    if (shuttlePass != null) data['shuttlePass'] = shuttlePass!.toJson();
    data['user'] = user;
    data['source'] = source;
    data['destination'] = destination;
    if (shuttleRoute != null) data['shuttleRoute'] = shuttleRoute!.toJson();
    if (shuttleShift != null) data['shuttleShift'] = shuttleShift!.toJson();

    data['returnSource'] = returnSource;
    data['returnDestination'] = returnDestination;
    if (returnShuttleRoute != null) data['returnShuttleRoute'] = returnShuttleRoute!.toJson();
    if (returnShuttleShift != null) data['returnShuttleShift'] = returnShuttleShift!.toJson();
